...
urlpatterns = [
    ...
    path('aeps-2-daily-kyc', view_paysprint_services.daily_kyc,  name='daily_kyc_paysprint'),
    # path('aeps-2-merchant-authenticity', view_paysprint_services.merchant_authenticity,  name='merchant_authenticity_paysprint'),
