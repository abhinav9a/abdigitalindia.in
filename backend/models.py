...
class Wallet2Transaction(models.Model):
    ...
    amount = models.DecimalField(max_digits=10, decimal_places=2)
    txnId = models.CharField(_("Bank Transaction Id"), max_length=500, blank=True, null=True)
    client_ref_id = models.CharField(_("Client Ref Id"), max_length=500, blank=True)
    description = models.CharField(max_length=255)
    timestamp = models.DateTimeField(auto_now_add=True)
    transaction_type = models.CharField(_("Transaction Type"), max_length=500, null=True, blank=True)
...
class PaySprintAEPSTxnDetail(models.Model):
    ...
    userAccount = models.ForeignKey(UserAccount, verbose_name=_("Linked User"), on_delete=models.CASCADE)
    aadhaar_no = models.CharField(_("Aadhaar No."), max_length=12, default="N/A", null=True)
    reference_no = models.CharField(_("Reference No"), max_length=500, blank=True, default="N/A", null=True)
    txn_status = models.CharField(max_length=20, choices=Txn_Status.choices, default=Txn_Status.Pending)
    message = models.CharField(_("Message"), max_length=500, blank=True, default="N/A", null=True)
    ack_no = models.CharField(_("ack_no"), max_length=500, blank=True, null=True, default="N/A")
    amount = models.DecimalField(_("Amount"), max_digits=10, decimal_places=2, blank=True, default=0.0)
    balance_amount = models.CharField(_("Balance Amount"), max_length=20, blank=True, default="0.0")
    bank_rrn = models.CharField(_("bank_rrn"), max_length=500, blank=True, default="N/A", null=True)
    bank_iin = models.CharField(_("bank_iin"), max_length=255, blank=True, default="N/A", null=True)
    service_type = models.CharField(max_length=20, choices=Service_Type.choices)
    timestamp = models.DateTimeField(auto_now_add=True)
